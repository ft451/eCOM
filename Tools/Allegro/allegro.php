 ...
 try
	{
		...
		{
			// jako klucz obieramy ID aukcji i przypisujemy mu list� klient�w
		...
		foreach($data as $id => $customers)
		{
			foreach($customers as $customer)
			{
				...
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'i') $pay_type = 'P�ac� z Inteligo';
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'd') $pay_type = 'P�a� z Nordea';
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'p') $pay_type = 'P�a� z iPKO';
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'h') $pay_type = 'P�a� z BPH';
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'g') $pay_type = 'P�a� z ING ';
				...
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'ab') $pay_type = 'P�ac� z Alior Bankiem';
				...
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 't') $pay_type = 'P�atno�� testowa';
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'collect_on_delivery') $pay_type = 'P�ac� przy odbiorze';
				if($dataForSellers[$counter]->{'post-buy-form-pay-type'} == 'wire_transfer') $pay_type = 'Zwyk�y przelew - poza systemem P�ac� z Allegro';
